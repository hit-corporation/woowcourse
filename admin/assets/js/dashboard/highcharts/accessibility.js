...
*/
(function(a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["highcharts"], function(A) {
        a(A);
        a.Highcharts = A;
        return a
    ...
    A(a, "Accessibility/Utils/HTMLUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, h) {
        ...
        function x(a, k, w) {
            ...
            return "function" ===
                typeof p.MouseEvent ? new p.MouseEvent(a, {
                    bubbles: !0,
                    cancelable: !0,
                    composed: !0,
                    button: 0,
        ...
        (function(a) {
            function z(a, d) {
                ...
                if (-1 < b) {
                    ...
                    a = "";
                    if (d = x(r[0], d))
                        for (b = isNaN(b) ? d.length : b, b = 0 > b ? d.length + b : Math.min(b, d.length), r = 0; r < b; ++r) a += c + d[r] + e;
                    return a.length ? a : ""
                }
                if (-1 < c) {
    ...
    A(a, "Accessibility/Utils/ChartUtilities.js", [a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function(a, h, l) {
        function x(c, e) {
            var d = e.type,
                a = c.hcEvents;
            k.createEvent && (c.dispatchEvent || c.fireEvent) ? c.dispatchEvent ? c.dispatchEvent(e) : c.fireEvent(d, e) : a && a[d] ? b(c, d, e) : c.element && x(c.element,
                e)
        }
    ...
    A(a, "Accessibility/Components/ContainerComponent.js", [a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"],
        a["Accessibility/Utils/ChartUtilities.js"], a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"]
    ], function(a, h, l, x, m) {
        ...
        return function(a) {
            ...
            f.prototype.handleSVGTitleElement = function() {
                ...
                if (c.length) {
                    var e =
                        this.svgTitleElement = this.svgTitleElement || g.createElementNS("http://www.w3.org/2000/svg", "title");
                    e.textContent = c;
                    e.id = b;
    ...
    A(a, "Accessibility/FocusBorder.js", [a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Utilities.js"]], function(a, h) {
        ...
        (function(h) {
            ...
            function k(b, c) {
                ...
                this.focusBorder = this.renderer.rect(k, h, v, n, parseInt((c &&
                    c.r || 0).toString(), 10) / f).addClass("highcharts-focus-border").attr({
                    zIndex: 99
                }).add(r);
            ...
            h.compose =
                function(c, a) {
                    -1 === b.indexOf(c) && (b.push(c), c = c.prototype, c.renderFocusBorder = p, c.setFocusToElement = z); - 1 === b.indexOf(a) && (b.push(a), a = a.prototype, a.addFocusBorder = k, a.removeFocusBorder = f)
                }
        })(m || (m = {}));
        return m
    });
    ...
    A(a, "Accessibility/Components/InfoRegionsComponent.js", [a["Accessibility/A11yI18n.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/Components/AnnotationsA11y.js"], a["Core/Renderer/HTML/AST.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function(a,
        ...
        return function(D) {
            ...
            y.prototype.updateScreenReaderSection = function(a) {
                ...
                e ? (this.setScreenReaderSectionAttribs(d,
    ...
    A(a, "Accessibility/Components/MenuComponent.js",
        [a["Core/Chart/Chart.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]],
        function(a, h, l, x, m, p) {
            ...
            h = function(a) {
                ...
                d.prototype.onKbdPrevious = function(a) {
                    ...
                    return e.keyboardNavigation.wrapAround ? (b.highlightLastExportItem(), a.success) :
                        a.prev
                };
                ...
                d.prototype.onKbdClick = function(a) {
                    ...
                    b.openMenu ? this.fakeClickEvent(e) : (this.fakeClickEvent(d),
    ...
    A(a, "Accessibility/KeyboardNavigation.js", [a["Core/Globals.js"], a["Accessibility/Components/MenuComponent.js"], a["Core/Utilities.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function(a, h, l, x, m) {
        ...
        l = function() {
            ...
            a.prototype.onFocus = function(a) {
                ...
                this.exiting ||
                    this.tabbingInBackwards || this.isClickingChart || a || (a = this.getFirstValidModuleIx(), null !== a && (this.currentModuleIx = a, this.modules[a].init(1)));
                this.exiting = !1
            };
        ...
        (function(f) {
            ...
            f.compose = function(a) {
                h.compose(a); - 1 === c.indexOf(a) && (c.push(a), a.prototype.dismissPopupContent = d); - 1 === c.indexOf(p) && (c.push(p), z(p, "keydown", b));
                return a
            }
        })(l || (l = {}));
        return l
    ...
    A(a, "Accessibility/Components/LegendComponent.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Globals.js"], a["Core/Legend/Legend.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function(a, h, l, x, m, p, K, z) {
        ...
        a = function(a) {
            ...
            b.prototype.updateLegendItemProxyVisibility = function() {
                ...
                (b.allItems || []).forEach(function(n) {
                    if (n.a11yProxyElement) {
                        ...
                        q ? a.styledMode ? B(y, "highcharts-a11y-invisible") : y.style.visibility = "hidden" :
            ...
            b.prototype.highlightAdjacentLegendPage = function(a) {
                ...
                var e = c.pages || [];
                if (0 < a && a <= e.length)
                    for (var d = e = 0, n = c.allItems; d < n.length; d++)((n[d].legendItem || {}).pageIx || 0) + 1 === a && (c = b.highlightLegendItem(e)) && (this.highlightedLegendItemIx = e), ++e
            };
            ...
            b.prototype.updateLegendTitle = function() {
                var a = this.chart,
                    b = J((a.legend && a.legend.options.title &&
                        a.legend.options.title.text || "").replace(/<br ?\/?>/g, " "));
            ...
            b.prototype.getKeyboardNavigation =
                function() {
                    var a = this.keyCodes,
                        b = this,
                        c = this.chart;
            ...
            b.prototype.onKbdClick = function(a) {
                ...
                b &&
                    b.a11yProxyElement && b.a11yProxyElement.click();
                return a.response.success
            };
    ...
    A(a, "Accessibility/Components/SeriesComponent/SeriesDescriber.js", [a["Accessibility/Components/AnnotationsA11y.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/FormatUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function(a, h, l, x, m) {
        ...
        function b(a) {
            ...
            e = y(e.xAxis && e.xAxis.options.accessibility && e.xAxis.options.accessibility.enabled,
                !n.angular);
            if (e) {
                var t = a.series;
                var q = t.chart;
        ...
        function c(a) {
            ...
            (c || e) && a.points.forEach(function(e) {
                ...
                f && (e.isNull && !d ? f.setAttribute("aria-hidden", !0) : (f.setAttribute("tabindex", "-1"), a.chart.styledMode || (f.style.outline = "none"), c && !t ? (q = e.series, t = q.chart.options.accessibility.point || {}, q = q.options.accessibility && q.options.accessibility.point || {}, e = n(q.descriptionFormatter && q.descriptionFormatter(e) ||
        ...
        return {
            ...
            describeSeries: function(a) {
                ...
                if (f) {
                    ...
                    b.options3d && b.options3d.enabled && d || !(d || q || y || u(a)) ? f.removeAttribute("aria-label") : (b = a.chart.options.accessibility, d = b.landmarkVerbosity, (a.options.accessibility || {}).exposeAsGroupOnly ? f.setAttribute("role",
        ...
        function(a, h, l, x, m, p) {
            ...
            h = function() {
                ...
                b.prototype.addEventListeners = function() {
                    ...
                    d.addEvent(b, "afterApplyDrilldown",
                        function() {
                ...
                b.prototype.queueAnnouncement = function(a, b, d) {
                    ...
                    if (e.enabled) {
                        ...
                        if (b = this.buildAnnouncementMessage(a, b, d)) this.queuedAnnouncement &&
        ...
        function(a, h, l, x, m) {
            ...
            return function() {
                function a(a, b, c, d) {
                    ...
                    e ? (c && !a.styledMode && (e.style.listStyle = "none"), e.appendChild(f), this.element = e) :
                        this.element = f;
    ...
    A(a, "Accessibility/ProxyProvider.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/DOMElementProvider.js"], a["Accessibility/Utils/HTMLUtilities.js"],
        ...
        return function() {
            ...
            a.prototype.addProxyElement = function(a, c, e) {
                var b = this.groups[a];
                if (!b) throw Error("ProxyProvider.addProxyElement: Invalid group key " +
                    a);
    ...
    A(a, "Stock/RangeSelector/RangeSelectorComposition.js", [a["Core/Defaults.js"], a["Stock/RangeSelector/RangeSelectorDefaults.js"], a["Core/Utilities.js"]], function(a, h, l) {
        function x() {
            ...
            if (E(a)) {
                var f = c - a;
                var t = a
            } else a && (f = c + e(c, -(a.count || 1)), this.chart &&
                (this.chart.fixedRange = c - f));
        ...
        function p() {
            ...
            b && (E(b.deferredYTDClick) && (b.clickButton(b.deferredYTDClick), delete b.deferredYTDClick),
                a.forEach(function(a) {
                    a.updateNames();
                    a.setScale()
        ...
        function w(a) {
            ...
            e && (u(this), b = b && b.verticalAlign || e.options && e.options.verticalAlign, e.options.floating || ("bottom" ===
        ...
        return {
            compose: function(a, c, q) {
                C = q; - 1 === H.indexOf(a) && (H.push(a), a.prototype.minFromRange = x); - 1 === H.indexOf(c) && (H.push(c), b(c, "afterGetContainer", m), b(c, "beforeRender", p), b(c, "destroy", z), b(c, "getMargins", g), b(c, "render", k), b(c, "update",
                    w), c.prototype.callbacks.push(u)); - 1 === H.indexOf(d) && (e(f, {
        ...
        h = function() {
            ...
            v.prototype.clickButton = function(b, c) {
                ...
                if (null !== h && null !== l) {
                    ...
                    else if (t) m = Math.max(G - t, h), G = Math.min(m + t, l), w = !1;
                    else if ("ytd" === k)
                        if (q) {
                    ...
                    else "all" === k && q && (d.navigator && d.navigator.baseSeries[0] &&
                        (d.navigator.baseSeries[0].xAxis.options.range = void 0), m = h, G = l);
            ...
            v.prototype.init = function(a) {
                ...
                this.eventsToUnbind.push(g(a, "load",
                    function() {
            ...
            v.prototype.setInputValue = function(a, b) {
                ...
                if (e) {
                    ...
                    e.value = d.dateFormat(this.inputTypeFormats[e.type] ||
                        c.inputEditDateFormat, n);
                    a && a.attr({
            ...
            v.prototype.defaultInputDateParser =
                function(a, b, c) {
            ...
            v.prototype.alignElements = function() {
                ...
                if (e && k && r) {
                    ...
                    m = 0;
                    "bottom" === l && (m = (m = d.legend && d.legend.options) && "bottom" === m.verticalAlign && m.enabled && !m.floating ? d.legend.legendHeight + B(m.margin,
                        10) : 0, b = b + m - 20, m = f - b - (g.floating ? 0 : g.y) - (d.titleOffset ? d.titleOffset[2] : 0) - 10);
                    if ("top" === l) g.floating && (m = 0), d.titleOffset && d.titleOffset[0] && (m = d.titleOffset[0]), m += d.margin[0] - d.spacing[0] || 0;
                    else if ("middle" === l)
                        if (r.y === k.y) m = f;
                        else if (r.y || k.y) m = 0 > r.y || 0 > k.y ? m - Math.min(r.y, k.y) : f - b;
                    e.translate(g.x, g.y + Math.floor(m));
                    k = this.minInput;
                    r = this.maxInput;
                    f = this.dropdown;
                    g.inputEnabled && k && r && (k.style.marginTop = e.translateY + "px", r.style.marginTop = e.translateY + "px");
                    f && (f.style.marginTop = e.translateY +
                        "px")
                }
            };
            ...
            v.prototype.handleCollision = function(a) {
                ...
                var h = function(b) {
                        if (e && d) {
                            var c = e.alignAttr.translateX +
                                e.alignOptions.x - a + e.getBBox().x + 2,
                ...
                e && d ? k.align === n.align || h(this.initialButtonGroupWidth + 20) ? "responsive" === g ? (this.collapseButtons(a),
                ...
                var b = this.buttons,
                    ...
                    k = function(a) {
                        return {
                            ...
                            paddingRight: B(f.buttonTheme.paddingRight,
                                g.padding, 8)
                        }
                    };
                n && n.hide();
            ...
            v.prototype.destroy = function() {
                ...
                e && (e.onfocus = e.onblur = e.onchange =
                    null);
                I(a, function(c, d) {
    ...
    A(a, "Accessibility/Components/SeriesComponent/ForcedMarkers.js", [a["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            ...
            function k() {
                ...
                if (d = this.chart.options.accessibility.enabled &&
                    d) d = this.chart.options.accessibility, d = this.points.length < d.series.pointDescriptionEnabledThreshold || !1 === d.series.pointDescriptionEnabledThreshold;
                if (d) {
        ...
        function(a, h, l, x, m, p, A, z) {
            ...
            l = function() {
                ...
                c.prototype.getKeyboardNavigationHandler = function() {
                    ...
                    return new p(e, {
                        keyCodeMap: [
                            [g ? [c.up, c.down] : [c.left, c.right], function(b) {
                ...
                c.prototype.attemptHighlightAdjacentPoint = function(a, c) {
                    ...
                    return e.highlightAdjacentPoint(c) ? a.response.success : f && (c ? b(e) : d(e)) ? a.response.success : a.response[c ? "next" :
                        "prev"]
                };
            ...
            (function(a) {
                ...
                function m() {
                    ...
                    if (a && c) {
                        for (var d = b; d < c; ++d)
                            if (!w(a[d])) return a[d].highlight();
                        for (; 0 <= b; --b)
                            if (!w(a[b])) return a[b].highlight()
                    }
                    return !1
                }
                var l = [];
                a.compose = function(a, f, g) {
                    -1 === l.indexOf(a) && (l.push(a), a =
                        a.prototype, a.highlightAdjacentPoint = b, a.highlightAdjacentPointVertical = d, a.highlightAdjacentSeries = e); - 1 === l.indexOf(f) && (l.push(f), f.prototype.highlight = h); - 1 === l.indexOf(g) && (l.push(g), f = g.prototype, f.keyboardMoveVertical = !0, ["column", "gantt", "pie"].forEach(function(a) {
    ...
    A(a, "Accessibility/Components/ZoomComponent.js", [a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/ChartUtilities.js"],
        a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Core/Utilities.js"]
    ], function(a, h, l, x, m) {
        var p = this && this.__extends || function() {
                var a = function(f, d) {
                    a = Object.setPrototypeOf || {
        ...
        return function(a) {
            ...
            f.prototype.onMapKbdArrow = function(a, b) {
                var c = this.chart,
                    ...
                    f = c.container,
                    g = b === d.up || b === d.down;
                b = (g ? c.plotHeight : c.plotWidth) / 10 * (b === d.left || b ===
                    d.up ? 1 : -1);
                d = 10 * Math.random();
                c = {
            ...
            f.prototype.onMapKbdTab = function(a, b) {
                ...
                if (d) return c.mapView &&
                    c.mapView.zoomBy(), a[b ? "prev" : "next"];
        ...
        function p(a) {
            ...
            a.series.forEach(function(k) {
                Object.keys(g).forEach(function(f) {
                    var d, b = k.options[f];
                    "accessibility.pointDescriptionFormatter" === f && (b = k.options.accessibility &&
    ...
    A(a, "Accessibility/Accessibility.js", [a["Core/Defaults.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/A11yI18n.js"], a["Accessibility/Components/ContainerComponent.js"],
        ...
        a["Accessibility/HighContrastTheme.js"], a["Accessibility/Options/A11yDefaults.js"], a["Accessibility/Options/LangDefaults.js"], a["Accessibility/Options/DeprecatedOptions.js"]
        ...
        (function(a) {
            ...
            a.compose = function(a, q, r, u, t, v) {
                ...
                m.compose(a);
                A.compose(a, t);
                v && b.compose(a, v); - 1 === p.indexOf(a) &&
                    (p.push(a), a.prototype.updateA11yEnabled = l, C(a, "destroy", d), C(a, "render", e), C(a, "update", h), ["addSeries", "init"].forEach(function(b) {
                        C(a, b, function() {
                            this.a11yDirty = !0
                        })
                    ...
                    })); - 1 === p.indexOf(r) && (p.push(r), C(r, "update", n)); - 1 === p.indexOf(u) && (p.push(u), ["update", "updatedData", "remove"].forEach(function(a) {
                    C(u, a, function() {
