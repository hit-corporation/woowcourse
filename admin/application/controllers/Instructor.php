...
class Instructor extends MY_Controller {
	...
	public function get_all_paginated(): void {
        ...
        $dataTable = [
            ...
            'data'            => $this->instructor_model->get_all($filter, $limit, $offset),
            'recordsTotal'    => $this->db->count_all_results('instructors'),
            'recordsFiltered' => $this->instructor_model->count_all($filter)
        ];
    ...
    public function get_all(): void {
        $data = $this->instructor_model->get_all();

        if(!empty($this->input->get('is_borrowing')))
            $data = $this->instructor_model->get_borrowing_member();
