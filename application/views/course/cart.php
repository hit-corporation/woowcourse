...
<div id="myModal" class="modal" tabindex="-1">
	<div class="modal-dialog">
		...
		<div class="modal-body">
			<p class="fw-bold" style="cursor: pointer;" data-bs-dismiss="modal">Transfer bank BCA ></p>
			<p class="fw-bold" style="cursor: pointer;" data-bs-dismiss="modal">Transfer bank Mandiri ></p>
			<p class="fw-bold" style="cursor: pointer;" data-bs-dismiss="modal">Transfer bank BNI ></p>
		</div>
