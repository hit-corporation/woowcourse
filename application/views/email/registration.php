...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
    	<!-- BEGIN BODY -->
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; box-shadow: 0px 1px 2px rgba(0, 0, 0, 0.3)">
      	<tr>
          ...
          <td valign="middle" class="hero bg_white" style="padding: 1em 0">
            ...
            <center>
				...
				<tr>
          <td valign="middle" class="hero bg_white" style="padding: 0.3em 0 2em 0;">
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				...
            				<p>
                                <a href="<?=base_url('verify/index/'.base64_encode($token.':'.$user_no))?>" style="box-shadow: 0px 0px 1px rgba(0,0,0,0.35); 
